...
public class login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lgEmail = findViewById(R.id.edtUserEmail);
        lgPassword = findViewById(R.id.edtUserPass);
        lgLoginBtn = findViewById(R.id.btnLogin);
        mCreateBtn = findViewById(R.id.createText);
        forgotTextLink = findViewById(R.id.forgotPassword);

        fAuth = FirebaseAuth.getInstance();

        lgLoginBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                if(password.length() < 6){
                    lgPassword.setError("Password Must be >= 6 Characters");
                    return;
                }
